...
map.getView().fit([256515.023300, 720401.461688, 259980.194867, 722550.005566], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Infrastructure Ahossoubgeta</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (84 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Carte situant l\'emplacement de différent infrastructure dans le quatier Ahossougbeta';
            }
